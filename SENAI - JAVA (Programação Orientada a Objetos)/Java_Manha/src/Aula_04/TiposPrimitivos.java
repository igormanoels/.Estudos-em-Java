...
public class TiposPrimitivos {
	...
	public static void main(String[] args) {
		...
		valor_01 = 3455;
		System.out.println(valor_01);
// variáveis podem ter seus valores sobrepostos no decorrer do programa, mas não é conveniente atribuir valores no meio do código
		
		final double PI = 3.14159265358979323846; 
// método para tornar uma variavel constante 
		System.out.println("O valor de PI é " + PI);
// PI = 455; 
// por ser uma constante a variável se torna imutavél, não sendo possivel atribuir outro valor para ela
