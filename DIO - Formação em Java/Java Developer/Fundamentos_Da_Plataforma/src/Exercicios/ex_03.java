 ...
 * todos os problemas, não esqueça de imprimir o fim de linha após o resultado, caso contrário, você 
...
public class ex_03 
{
    public static void main(String[] args) 
    {
        ...
        sc.useLocale(Locale.US); // FIXA O SCANNER CONFORME UM PADRÃO DE PONTUAÇÃO, ENTRE VIRGULA E PONTO.
